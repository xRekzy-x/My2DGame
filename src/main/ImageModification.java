...
public class ImageModification {
    ...
    public void crop(int x, int y, String fileName) {
        try {
            ...
            BufferedImage spriteSheet = ImageIO.read(new File(
                    "C:/Users/rosto/practice/tutorial/loopex/java lab/My2DGame/My2DGame/src/res/tile/Fences.png"));

            // Define the crop area (x, y, width, height)
            // Adjust based on the sprite position

            int width = 16; // Width of a single sprite
            int height =16; // Height of a single sprite
            ...
            File outputFile = new File("My2DGame/src/res/tile/" + fileName + ".png");
    ...
    public void flip(String fileName){
        try {
            ...
            ImageIO.write(flippedImage, "png", new File("My2DGame/src/res/tile/" + fileName + ".png"));
    ...
    public BufferedImage scaleImage(BufferedImage original,int height,int width){
            ...
            store.setRenderingHint(RenderingHints.KEY_INTERPOLATION, RenderingHints.VALUE_INTERPOLATION_BILINEAR);
